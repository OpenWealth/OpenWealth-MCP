"""MCP server composition root for OpenWealth Custody Services."""
...
from openwealth_mcp.app import get_app
...
def main() -> None:
    ...
    # create_mcp and get_app are resolved at runtime so test patches work.
    server = create_mcp()
    _ = get_app().client
    run_stdio("openwealth-custody", server, get_app, log)
